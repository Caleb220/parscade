...
const pipelineSteps: PipelineStep[] = [
  {
    ...
    description: 'Upload and process documents from multiple sources including PDFs, Word docs, images, and more.',
    icon: 'FileText',
    status: 'completed',
  },
  {
    ...
    description: 'Advanced AI algorithms extract structured data from unstructured documents with high accuracy.',
    icon: 'Zap',
    status: 'processing',
  },
  {
    ...
    description: 'Transform parsed content into clean, structured formats ready for your applications.',
    icon: 'Database',
    status: 'pending',
  },
  {
    ...
    description: 'Seamlessly deliver processed data to your systems via APIs, webhooks, or direct integrations.',
    icon: 'Send',
    status: 'pending',
  },
];
